  ...
  module.exports = SmoothScroll = (function() {
    ...
    SmoothScroll.prototype.scroll = function() {
      ...
      _$body.stop(true, true).animate({
        ...
        return function() {
          var _base1;
          return typeof (_base1 = _this.opts).onScrollAfter === "function" ? _base1.onScrollAfter(_this.el) : void 0;
        };
      })(this));
      return this;
    };
    ...
    SmoothScroll.prototype.destroy = function() {
      ...
      this.unbind();
      _results = [];
      for (i = _i = 0, _len = _collection.length; _i < _len; i = ++_i) {
        el = _collection[i];
        if (el === this) {
